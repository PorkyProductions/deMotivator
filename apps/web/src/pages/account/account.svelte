			...
			<div class="container">
				<div class="text-center">
					<a href="/" class="text-decoration-none">
						<span class="display-6 fw-bold text-body"><Title /></span>
					</a>
			...
			{#if loggedIn}
				<div class="row g-4 align-items-stretch">
					...
					<div class="col-12 col-xxl-4">
						<div class="card h-100 border-0 shadow-sm rounded-4 border-l-4 border-primary-majorelle-blue dark:border-primary-majorelle-blue">
