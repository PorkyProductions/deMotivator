...
import Auth from "../routes/login/auth.svelte";
...
<div class="drop-shadow-md">
    {#if darkMode}
        {#if loggedIn}
        <a href="/login" class="flex justify-between content-center bg-gray-600 hover:bg-gray-700 text-white p-2 rounded-lg">
    ...
    {:else}
        {#if loggedIn}
        <a href="/login" class="flex justify-between content-center bg-white hover:bg-gray-200 text-black p-2 rounded-lg">
